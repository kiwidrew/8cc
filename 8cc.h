...
Type *node_functype(Node *);
Vector *node_funcall_args(Node *);
Node *ast_funcdesg(Type *ty, char *fname);
Node *ast_funcptr_call(Node *fptr, Vector *args);
Node *node_funcptr(Node *);
Node *ast_func(Type *ty, char *fname, Vector *params, Node *body, Vector *localvars);
Node *node_funcbody(Node *);
Vector *node_funclocals(Node *);
Vector *node_funcparams(Node *);
char *node_funcname(Node *);
...
Node *node_initval(Node *);
Type *node_totype(Node *);
Node *ast_conv(Type *totype, Node *val);
Node *ast_return(Node *retval);
Node *node_retval(Node *);
...
char *node_glabel(Node *);
Vector *node_lvarinit(Node *);
void node_set_lvarinit(Node *, Vector *);
int node_loff(Node *);
void node_set_loff(Node *, int);
int node_kind(Node *);
SourceLoc *node_loc(Node *);
Type *node_type(Node *);
...
char *node_literal_flabel(Node *);
void node_set_flabel(Node *, char *);
char *node_literal_sval(Node *);
char *node_literal_slabel(Node *);
void node_set_slabel(Node *, char *);
